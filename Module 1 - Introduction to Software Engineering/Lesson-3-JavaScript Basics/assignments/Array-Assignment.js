...
const arr = [biengeWatchSeries]
const arr1 = [memorizeFormulas]

// 2.   Using an array method, add another thing you like to do to that list
const arr2 = [exerciseDaily]

// 3.   Reverse the order of the array (remember, if needed use MDN)
varArr = ['remember, if needed use MDN'];
arrReverse(); // returns [if needed use MDN, remember]
